...
export class ChatService implements OnInit{
  ...
  getGeneratedToken(){
    let token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..FsonW312AOeRVT29evxBpKDmdzy7a2iK6lprDoTue9U";
    this.connect(token);
  }
